...
// (Mantenemos tus iconos existentes...)
...
// ... (Tus Arrays de Colores y Fuentes ACCENT_COLORS, TEXT_COLORS, FONTS, BORDER_STYLES) ...
const ACCENT_COLORS = [
...
// ... (Funciones getLuminance y getContrastRatio) ...
...
function Settings({ config, onUpdate }) {
    ...
    const shopStyles = useMemo(() => {
        ...
        const hasBanner = !!config.bannerUrl && isPremium; // Verificamos si hay banner activo
        ...
        // LÓGICA DE CONTRASTE DINÁMICO DEL HERO
        const heroOverlayStyle = hasBanner
            ? 'linear-gradient(to bottom, rgba(0,0,0,0.4), rgba(0,0,0,0.8))' // Overlay oscuro fuerte si hay imagen
            : isDarkMode ? 'linear-gradient(to bottom, rgba(0,0,0,0.2), var(--shop-bg))' : 'linear-gradient(to bottom, rgba(255,255,255,0.5), var(--shop-bg))'; // Overlay sutil si no hay imagen

        const heroTextColor = hasBanner ? '#ffffff' : userTitleColor; // Fuerza blanco si hay imagen
        const heroSubtextColor = hasBanner ? 'rgba(255,255,255,0.8)' : userSubtitleColor; // Fuerza blanco translúcido si hay imagen
        ...
        return {
            ...
            '--hero-overlay': heroOverlayStyle, // Nueva variable CSS
            '--hero-text-color': heroTextColor, // Nueva variable CSS
            '--hero-subtext-color': heroSubtextColor // Nueva variable CSS
        };
    }, [config]);
        ...
        <div className="settings-editor-layout">
            ...
            <div className="settings-controls-panel glass-effect">
                ...
                <div className="accordions-container">
                                ...
                                <PremiumGate isPremium={isPremium}>
                                    <div className="settings-form-group">
                                        <label className="settings-label">URL Imagen de Portada:
                                            <input type="text" name="bannerUrl" value={config.bannerUrl || ''} onChange={handleChange} className="settings-input" />
                                        </label>
                    ...
                    {/* FUNCIONALIDADES MARKETING (SOLO VISIBILIDAD, NO EDICIÓN) */}
                    ...
                    <div className={previewMode === 'mobile' ? 'phone-mockup-final' : 'desktop-mockup-final'}>
                        {previewMode === 'mobile' ? (
                            <div className="phone-header-bar">
                                ...
                                {/* SE ELIMINÓ EL ICONO DE SEÑAL AQUÍ */}
                        ...
                        <div className="shop-screen" style={shopStyles}>
                            ...
                            <div className="shop-hero" style={config.bannerUrl && isPremium ? { backgroundImage: `url(${config.bannerUrl})` } : {}}>
                                ...
                                <div className="shop-hero-content animate-pop-in">
                                    ...
                                    {/* GARANTÍA MOVIDA DENTRO DEL HERO PARA EVITAR DESBORDAMIENTO */}
